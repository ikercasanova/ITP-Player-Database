...
const TEST_DEFS = {
  ...
  trapBarDL:  { name: 'Trap Bar Deadlift',unit: 'x BW',  category: 'Explosive Power', lowerIsBetter: false },
...
const DEFAULT_BENCHMARKS = {
  'U-17': {
    ...
    trapBarDL:  { poor: 1.0, average: 1.3, good: 1.6, elite: 2.0 },
    pullUps:    { poor: 2, average: 5, good: 8, elite: 12 },
    ift3015:    { poor: 18.5, average: 20.0, good: 20.5, elite: 21.5 },
  ...
  'U-19': {
    ...
    trapBarDL:  { poor: 1.2, average: 1.5, good: 1.8, elite: 2.2 },
  ...
  'U-21': {
    ...
    trapBarDL:  { poor: 1.3, average: 1.6, good: 2.0, elite: 2.5 },
